...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;\delta(\theat_{i1})=\frac{\sin{(\frac{\delta_{m}+\alpha}{2})}}{\sin{(\frac{\alpha}{2})}}" title="\Large x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}" />
